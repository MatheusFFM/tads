<template>
  <div>
    <v-row class="mt-3 mb-14">
      <v-col cols="2" />
      <v-col cols="8">
        <H2Atom class="title">Calendar</H2Atom>
        <CalendarOrganism :props="getCalendar()" class="mt-8 content" />
      </v-col>
      <v-col cols="2" />
    </v-row>
  </div>
...
export default class CalendarTemplate extends Vue {
  @Prop()
  public props!: ICalendarProps;

  public getCalendar(): ICalendarProps {
    return {
